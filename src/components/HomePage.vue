  ...
  <section class="grid lg:grid-cols-12 gap-8">
    ...
    <aside class="xl:col-span-2 lg:col-span-3 hidden lg:flex">
      <div class="fixed h-screen flex flex-col justify-between py-4">
        ...
        <!-- BOTTOM -->
        <div class="sticky flex items-center bottom-8 gap-1 w-full bg-transparent hover:bg-black/3 py-1 px-4 rounded-full" @click="handlePopover">
        ...
        <div
            v-if="showPopover"
            ref="popoverRef"
            class="fixed bottom-17 w-50 mb-8 px-4 py-3 bg-white rounded shadow text-sm z-10"
            @click.stop
          >
